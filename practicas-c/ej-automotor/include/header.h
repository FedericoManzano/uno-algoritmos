...
void actualizarAutomotor_res(
	FILE *arch_autos, FILE *arch_parche, t_arbol *indice_autos, t_lista *listado_bajas);
void mostrarListaBajas_res(t_lista * lista);



/// Funciones a realizar
void actualizarAutomotor(FILE *, FILE *, t_arbol *, t_lista *);
int borrarNodo(t_arbol *, t_info_arbol *, t_cmp);
int buscarClave(t_arbol *, t_info_arbol *, t_cmp);
int insertarEnOrden(t_lista *, const t_info_lista *, t_cmp);
